    ...
    if (trees !== undefined) {
        treeMarkers = trees.map(tree => {
            ...
            const svgPath = `<?xml version="1.0" encoding="iso-8859-1"?>
						...
						<path style="fill:${markerColor}" d="M485.271,240.532c0-35.798-21.77-66.511-52.792-79.623c5.478-10.59,8.592-22.602,8.592-35.348
						...
						<g>
							<path style="fill:${markerColor}" d="M251.377,0.153c-0.949,0.057-1.894,0.125-2.833,0.217c-0.288,0.028-0.574,0.06-0.86,0.091
							...
							<path style="fill:${markerColor}" d="M432.479,160.909c5.479-10.59,8.592-22.602,8.592-35.348c0-42.561-34.502-77.063-77.063-77.063
						...
						<path style="fill:${markerColor}" d="M200.82,339.895c-6.95,11.788-35.752,24.969-46.433,25.718c1.175,0.252,2.366,0.472,3.567,0.668
						...
						<path style="fill:${markerColor}" d="M241.333,60.5c-21.621,0-40.232,12.832-48.669,31.29c-8.716-6.159-19.346-9.79-30.831-9.79
